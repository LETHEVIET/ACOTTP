...
//        System.out.println(b3);
    ...
    static void construct_solutions()
        ...
        for (k = 0; k < Ants.n_ants; k++) {
            ...
            Ants.ant[k].tour_length = Tsp.compute_tour_length(Ants.ant[k]);
            if (Ants.acs_flag)
                Ants.local_acs_pheromone_update(Ants.ant[k], step);
        }
...
//                System.out.println(" from "+obOld+" to "+obNew);
                ...
                // update hashmap?
                Double inserted = Tsp.tours.put(Arrays.toString(tlocal), Ants.ant[iteration_best_ant].sol).getObjective() * -1;
